...
export interface Client {
  ...
  getRecord(collection: string, slug: string, locale?: string): Promise<unknown | null>
  listRecords(
    collection: string,
  ...
  records?: { create: (collection: string, data: unknown, opts?: { idempotencyKey?: string }) => Promise<unknown> }
}
